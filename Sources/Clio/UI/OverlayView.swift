...
struct OverlayView: View {
    ...
    private static let pillFill = Color(red: 220/255, green: 220/255, blue: 219/255)
    private static let recordDot = Color(red: 241/255, green: 107/255, blue: 51/255)
    private static let spinner = Color(red: 240/255, green: 168/255, blue: 77/255)
    private static let closeGrey = Color(red: 158/255, green: 158/255, blue: 157/255)
    ...
    var body: some View {
        ...
        .frame(height: h)
        .background(Capsule().fill(Self.pillFill))
        .clipShape(Capsule())
    ...
    private var leading: some View {
        ...
        case .transcribing, .injecting:
            Spinner(diameter: h * 0.29, colour: Self.spinner)
    ...
    private var content: some View {
        if model.state == .recording {
            LevelMeter(level: model.level, height: h)
            ...
            if model.isNearLimit {
                Text("\(model.progress.display) left")
                    .font(.system(size: h * 0.21, weight: .semibold,
                                  design: .monospaced))
...
/// cannot be the orange the design asks for; and it renders as a placeholder
